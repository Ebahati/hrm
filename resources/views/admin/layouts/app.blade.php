...
<div class="toast toast-onload align-items-center text-bg-primary border-0" role="alert" aria-live="assertive" aria-atomic="true" id="greetingToast">
  ...
  <script>
  // Assuming you have the username stored in a variable
  const username = "Admin"; // Replace with actual username from your login system

  function getGreeting() {
      const hour = new Date().getHours(); // Get the current hour
      if (hour < 12) {
          return "Good Morning"; // From 12 AM to 11:59 AM
      } else if (hour < 18) {
          return "Good Afternoon"; // From 12 PM to 5:59 PM
      } else {
          return "Good Evening"; // From 6 PM to 11:59 PM
      }
  }

  // Set the greeting and username in the toast

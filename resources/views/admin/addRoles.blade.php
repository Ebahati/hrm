                ...
                <form class="form-horizontal r-separator">
                  <div class="card-body">
                    ...
                    <div class="form-group mb-0">
                      <div class="row align-items-center">
                        <label for="inputText12" class="col-3 text-end  col-form-label">Role
                         </label>
                    ...
                    <div class="form-group mb-0">
                      <div class="row align-items-center">
                        <label for="inputText12" class="col-3 text-end  col-form-label">Description
                         </label>
                        <div class="col-9 border-start pb-2 pt-2">
                          <input type="text" class="form-control" id="inputText12" placeholder="Project Name Here" />
                        </div>
                  ...
                  <div class="p-3 border-top">
                    ...
                    <a href="{{ route('manageAwardCategories') }}" class="btn btn-primary">Add</a>

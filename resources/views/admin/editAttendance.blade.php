                ...
                <form class="form-horizontal r-separator">
                  <div class="card-body">
                    <div class="form-group mb-0">
                      <div class="row align-items-center">
                        <label for="inputText11" class="col-3 text-end  col-form-label">Absent/Leave
                          Name</label>
                    ...
                    <div class="form-group mb-0">
                      <div class="row align-items-center">
                        <label for="inputText12" class="col-3 text-end  col-form-label">Time In
                         </label>
                        <div class="col-9 border-start pb-2 pt-2">
                    ...
                    <div class="form-group mb-0">
                      <div class="row align-items-center">
                        <label for="inputText12" class="col-3 text-end  col-form-label">Time Out
                         </label>
                        <div class="col-9 border-start pb-2 pt-2">
                          <input type="text" class="form-control" id="inputText12" placeholder="Project Name Here" />
                        </div>
                  ...
                  <div class="p-3 border-top">
                    ...
                    <a href="{{ route('manageAttendance') }}" class="btn btn-primary">Edit Attendance</a>
